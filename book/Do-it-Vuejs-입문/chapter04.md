...
| API 유형                              | 처리 결과                                                                                    |
|---------------------------------------|---------------------------------------------------------------------------------------------|
| axios.get('URL 주소').then().catch()  | HTTP GET 요청. 성공하면 then(), 실패하면 catch() 실행.                                        |
| axios.post('URL 주소').then().catch() | HTTP POST 요청. 성공하면 then(), 실패하면 catch() 실행.                                       |
| axios({옵션속성})                     | HTTP 요청에 대한 속성들을 직접 정의하여 보낼 수 있다. URL, HTTP 메소드, 보내는 데이터 유형 등등. |
